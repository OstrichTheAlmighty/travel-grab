...
### Market Research
- [ ] [P1] [Added: 2026-06-03] [By: Claude] Define and size the TAM — global travel market + AI-personalization segment
- [ ] [P1] [Added: 2026-06-14] [By: Claude] Size the group travel segment specifically — % of trips that are group, avg group size, avg booking value vs. solo
- [ ] [P1] [Added: 2026-06-03] [By: Claude] Deep-dive direct competitors (Layla, Mindtrip, GuideGeek, TripAdvisor AI) — verify all entries in `market-research.md`
- [ ] [P1] [Added: 2026-06-14] [By: Claude] Audit competitors specifically for group travel features — is there a gap we can own?
- [ ] [P1] [Added: 2026-06-03] [By: Claude] Deep-dive indirect competitors (OTAs: Expedia, Booking.com; tools: Wanderlog, TripIt)
- [ ] [P1] [Added: 2026-06-14] [By: HU] Validate Group Coordinator persona (Persona A) with real interviews — confirm pain point severity and willingness to pay
...
*Lower priority — revisit after MVP definition.*

- Explore partnership angles with airlines or hotel chains
- Offline / low-connectivity use case research
- Regulatory considerations (travel licensing, data privacy)
